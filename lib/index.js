...
function _convert(path, format, outdir) {
    ...
    var executionTimer = setTimeout(function() {
            ...
            if (logLevel === 'trace') logger.warn('gebo-imagemagick:', kill);
    ...
    mkdirp(outdir, function(err, made) {
        ...
        if (mimeType === 'application/pdf') {
          command = 'convert -interlace none -quality 100 ' + path + ' ' + outdir + '/%0d_' + outputFileName + ' & echo $! > /tmp/' + outputFileName + '.pid';
        }
        else {
