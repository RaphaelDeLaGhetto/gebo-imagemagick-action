...
//        command += outputFileName + ' & echo $! > /tmp/' + outputFileName + '.pid';
        ...
        //if (logLevel === 'trace') console.log('gebo-imagemagick: no extension?', mimeType);
//        console.log('mimeType', mimeType);
        ...
        // Probably no extension
//        else if (mimeType ==='application/octet-stream') {
//          // Why do I need this? Comment it out and tests will fail
//          if (logLevel === 'trace') console.log('gebo-imagemagick: no extension?', mimeType);
//          
//          command = 'convert ' + path + ' ' + outdir + '/' + outputFileName + ' & echo $! > /tmp/' + outputFileName + '.pid';
//        }
        else {
...
//        var command;
//        if (mime.lookup(path) === 'application/pdf') {
//          command = 'convert -interlace none -density 300 -quality 100 ' +
//                    path + ' ' + outdir + '/%0d_' + outputFileName + ' & echo $! > /tmp/' + outputFileName + '.pid';
//        }
//        else {
//          command = 'convert -quality 100 ' + path + ' ' + outdir + '/' + outputFileName + ' & echo $! > /tmp/' + outputFileName + '.pid';
//        }
